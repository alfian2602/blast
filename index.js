...
const configs = {
	...
	webhook_url: 'http://localhost/wablast/filewebhook/webhook.php',
	webhook_group: 'http://localhost/wablast/hookgroup.php',
	callback_url: 'http://localhost/wablast/callback.php' // webhook url
};
